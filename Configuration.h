...
// Configured by Parksy for HKBAY.COM Kossell Mini
...
#define DEFAULT_DELTA_DIAGONAL_ROD 334.0 // mm  //MR: changed from Mini:214.0 XL:334.0
...
#define Z_PROBE_RETRACT_END_LOCATION {-45, 132, 10.9, 0}     // X, Y, Z, E end location for z-probe retract sequence, MR changed from {-24, 94, 11, 0}
...
#define PREVENT_DANGEROUS_EXTRUDE //MR: Comment for calibration or use M302
...
#define HOMING_FEEDRATE {150*60, 150*60, 150*60, 0}  // set the homing speeds (mm/min)  MR: Changed from 80*60
